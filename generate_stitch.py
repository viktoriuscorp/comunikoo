...
<div class="max-w-3xl mx-auto">
<div class="text-center mb-10">
<span style="display:inline-block;padding:.5rem 1.25rem;border-radius:50px;background:rgba(56,189,248,.15);border:1px solid rgba(56,189,248,.3);color:#38bdf8;font-weight:700;font-size:.75rem;text-transform:uppercase;letter-spacing:.1em;margin-bottom:1rem">Herramienta gratuita</span>
