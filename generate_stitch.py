...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-WCHWH6J2KC"></script>
<script>window.dataLayer=window.dataLayer||[];function gtag(){{dataLayer.push(arguments)}}gtag('js',new Date());gtag('config','G-WCHWH6J2KC');</script>
<title>{title}</title>
